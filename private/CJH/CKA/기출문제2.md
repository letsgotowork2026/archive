...
kubectl get service -n nginx-static

kubectl get configmap nginx-config -n nginx-static -o yaml > configmap.yaml
...
metadata````
    ...
    kubectl.kubernetes.io/last-applied-configuration: |
        {
            "apiVersion":"v1","data":{
                "nginx.conf":"events {}\nhttp {\n server {\n listen 443 ssl;\n server_name ITKiddie.k8s.local;\n\n ssl certificate /etc/nginx/ssl/tls.crt;\n ssl_certificate_key /etc/nginx/ssl/tls.key;\n\n ssl_protocols TLSv1.2 TLSv1.3;\n ssl_ciphers HIG H: !aNULL: !MD5;\n\n location / {\n return 200 'TLS Is Working IT Kiddie!\\n'; \n }\n }\n }\n"}, "immutable":true,"kind":"ConfigMap","metadata":{"annotations":{},"name":"nginx-config", "namespace":"nginx-static"
            }
        }
    creationTimestamp: "2025-06-09T18:59:11Z"
    name: nginx-config
    namespace: nginx-static
    resourceVersion: "7795"
    uid: 754a435f-a793-43c8-8b56-edfa3f573aa8
...
sudo echo '10.100.46.136 ITKiddle.k8s.local' >> /etc/hosts
cat /etc/hosts
